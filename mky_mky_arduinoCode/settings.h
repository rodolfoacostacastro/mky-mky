...
int keyCodes[NUM_INPUTS] = {
 ...
 // KEY_LEFT_ARROW,    // left arrow pad
  ...
  's',                 //*first leg of the board (clock-wise)
  KEY_DOWN_ARROW,      //*last  leg of the board (clock-wise)
  'd',                 //*sixth  leg of the board (clock-wise) 
  'e',                 //*fifth  leg of the board (clock-wise)
  KEY_UP_ARROW,        //*forth leg of the board (the middle one!)
  'q',                 //*third leg of the board (clock-wise)
  'a'                  //*second leg of the board (clock-wise)
